...
public class Shop extends State {
    ...
    Rectangle rect1,rect2,applerect;
    ...
    public Shop(GameStateManager gms, float x, float y,int AmountHp,int money) {
        super(gms);
    ...
    public void update(float dt) {
        ...
        if (k==0&&player.getPlayerRect().overlaps(previousrect)){
            gms.set(new Fifth(gms, 40, player.getPosition().y,player.getAmountHp(),player.getMoney()));
